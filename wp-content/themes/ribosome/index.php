...
<head>
	...
	<!-- Plugins CSS -->
	<link rel="stylesheet" href="<?php echo get_template_directory_uri()?>/css/font-awesome-4.7.0/css/font-awesome.css">

	<!-- Theme CSS -->
	<link id="theme-style" rel="stylesheet" href="<?php echo get_template_directory_uri()?>/css/styles.css">
...
<div class="wrapper">
	<div class="sidebar-wrapper">
		<div class="profile-container">
			<img  with="100" height="150" class="profile" src="<?php echo get_template_directory_uri()?>/img/me.jpg" alt="" />
			<h3 class="name">Truong Hoang</h3>
